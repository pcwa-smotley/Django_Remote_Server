    ...
    top_row = dbc.Row([
        ...
        html.Div([
            dbc.Card([
                ...
                dbc.CardBody(
                    children=[
                        html.Div(id="StartEnd_Label",
                                 className='row justify-content-end',
                                 style={"border-bottom": "1px solid #ccc"},
                                 children=[
                                     html.Div(children=[
                                         html.Div("Starting MW",
                                                  style={"position":"absolute", "left":"5px","top":"-20px",
                                                         "font-size":"12px"},
                                                  id="oxbow_starting_mw"),
                                         dcc.Input(
                                             id="input_mw_range", type="number", placeholder="OXB",
                                             min=0, max=6, step=0.1, style={"width":"50px", "height":"20px",
                                                                            "font-size":"12px", "margin-bottom":"5px"}
                                         )
                                     ], className="col-4 ml-0"),
                                     html.P(f" Start Time", id="rec_stime_text", className="col-4 ml-0 text-size-1"),
                                     html.P(f" End Time", id="rec_etime_text", className="col-4 ml-0 text-size-1"),
                                    ]),
                        html.Div(id="Today_Times", className='row h-50 pt-2', children=[
                                     ...
                                     html.Div(daq.LEDDisplay(
                                                id="rec_d1_stime_led",
                                                size=20,
                                                value=rec_start_today,
                                                color="#28A828",
                                                backgroundColor="#343a40"
                                             ),
                                              className='col-4 .offset-md-2 ml-0'),
                                        html.Div(daq.LEDDisplay(
                                            id="rec_d1_etime_led",
                                            size=20,
                                            value=rec_end_today,
